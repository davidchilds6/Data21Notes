...
# print(result)  # <sqlalchemy.engine.cursor.LegacyCursorResult object at 0x03E58C40>
#
...
# If fetchall is used after fetchone, fetchone will print independently of fetch all

# Giacomo's way
query = 'SELECT * FROM Orders o JOIN [Order Details] od ON od.OrderID = o.OrderID'
